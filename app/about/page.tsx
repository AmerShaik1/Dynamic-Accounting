  ...
  return (
    <main>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-600">
              10+ Years of Excellence in Tax and Accounting Services
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-slate-600 mb-4 leading-relaxed">
                Dynamic Accounting Services was founded on a simple belief: everyone deserves expert,
                personalized tax and accounting services without the corporate overhead and impersonal
                service.
              </p>
              <p className="text-lg text-slate-600 mb-4 leading-relaxed">
                For over 10 years, we&apos;ve been building lasting relationships with individuals and
                small business owners in United States, serving as their trusted financial advisors
                during critical decisions and challenging periods.
              </p>
              <p className="text-lg text-slate-600 mb-4 leading-relaxed">
                Our commitment to excellence, proactive planning, and client success has earned us the
                trust of hundreds of satisfied clients who rely on us for strategic financial guidance
                and expert preparation.
              </p>
              <p className="text-lg text-slate-600 leading-relaxed">
                Today, we continue that mission - combining decades of expertise with modern technology
                to deliver results that transform financial outcomes.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                { num: 'Over $2M+', label: 'Tax Savings Generated' },
              ].map((stat, idx) => (
                <Card
                  key={idx}
                  className="p-6 bg-gradient-to-br from-slate-50 to-lime-50 border border-slate-200 text-center"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <Card className="p-8 bg-gradient-to-br from-slate-50 to-lime-50 border-2 border-lime-200">
              ...
              <p className="text-lime-500 font-semibold text-center mb-6">
                Certified Tax Advisor &amp; Founder
              </p>

              <div className="space-y-4 mb-6">
                <p className="text-slate-700 leading-relaxed">
                  With over 10 years of experience in tax preparation, accounting, and financial
                  planning, Shehzad founded Dynamic Accounting Services with a vision to provide
                  personalized, expert service to individuals and small businesses.
                </p>
                <p className="text-slate-700 leading-relaxed">
                  As a Certified Tax Advisor, Shehzad stays current with the latest tax laws and
                  strategic opportunities to help clients minimize their tax burden and maximize
                  financial success.
                </p>
              </div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    desc: 'Deep understanding of state specific knowledge, business environment, regulations, and opportunities.',
                  },
                  {
                  ...
                  <div
                    key={idx}
                    className="bg-slate-50 p-4 rounded-lg border-l-4 border-l-lime-500"
                  >
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Why Trust Us</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                credential: '10+ Years Experience',
              ...
              <Card
                key={idx}
                className="p-8 bg-gradient-to-br from-slate-50 to-lime-50 border border-lime-200 text-center"
              >
      ...
      <section className="py-20 bg-gradient-to-r from-slate-800 to-lime-500">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Schedule a free consultation with Shehzad to discuss your financial goals.
          </p>
          <Link href="/contact">
